...
const coreValues = [
    ...
    },
    {
        ...
        description: "Innovative solutions that blend creativity with cutting-edge technology.",
    ...
    {
        title: "24/7 Support",
        description: "Dedicated support team always ready to help you succeed and grow.",
...
const whyChooseUs = [
    {
        ...
        description: "Over 500 successful projects delivered to satisfied clients worldwide",
    ...
    },
    {
        ...
        description: "We use the latest technologies and best practices in all our work",
    ...
    return (
        ...
        >
            <div className="group relative cursor-pointer">
                ...
                {/* Main bubble */}
                <div className="relative backdrop-blur-xl bg-white/80 rounded-full p-6 sm:p-8 shadow-2xl border border-white/50 group-hover:scale-110 transition-all duration-500">
                    ...
                    {/* Rotating ring */}
                    <div className="absolute inset-0 rounded-full border-2 border-transparent border-t-blue-500 border-r-purple-500 opacity-0 group-hover:opacity-100 group-hover:animate-spin transition-opacity duration-500" style={{ animationDuration: '3s' }} />
                </div>
            </div>
        </div>
    );
...
function CoreValueItem({ value, index }) {
    ...
    return (
        ...
        >
            {/* Background glow */}
            <div className={`absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 rounded-3xl opacity-0 blur-xl transition-all duration-500 ${isHovered ? 'opacity-30' : ''}`} />
            ...
            <div className="relative h-full rounded-3xl border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
                ...
                <div className="relative h-full flex items-center p-6 md:p-8">
                    <div className="max-w-xl">
                        <h3 className={`text-2xl md:text-3xl font-bold mb-2 transition-all duration-300 ${isHovered ? 'text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text' : 'text-gray-800'}`}>
                            {value.title}
                        </h3>
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500">
                    <div className={`h-full bg-white/50 transition-all duration-500 ease-out ${isHovered ? 'w-full' : 'w-0'}`} />
                </div>
    ...
    return (
        ...
        >
            ...
            <div className="relative h-96 overflow-hidden rounded-3xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-blue-600/90 via-blue-600/60 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 backdrop-blur-sm" />
            ...
            <div className="relative h-full p-6 md:p-8 flex flex-col justify-between z-10">
                <div>
                    ...
                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-4 group-hover:bg-white/10 group-hover:border-white/40 group-hover:scale-110 transition-all duration-500">
                        <span className="text-sm font-bold text-white/70 group-hover:text-white transition-colors duration-300">0{index + 1}</span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <div ref={aboutTextRef} className="space-y-6">
                            <h2 className="text-4xl font-bold text-gray-800">
                                ...
                                <span className="bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent"> Since 2022</span>
                            </h2>
                            <p className="text-gray-600 text-lg leading-relaxed">
                                We started with a simple mission: to help businesses harness the power of digital technology. Today, we're proud to be a trusted partner for companies worldwide, delivering exceptional results through web development, SEO, content creation, and stunning design.
                            </p>
                            <p className="text-gray-600 text-lg leading-relaxed">
                                Our team blends technical expertise with creative vision to deliver solutions that not only look stunning but also drive measurable business growth. We take pride in building lasting relationships with our clients, founded on trust, transparency, and a proven track record of success.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mb-20">
                        <div className="text-center mb-8 sm:mb-12">
                            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-3">
                                Our <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">Impact</span> in Numbers
                            </h3>
                            <p className="text-gray-600 text-sm sm:text-base">Real results that speak for themselves</p>
                        </div>
                        ...
                        <div className="hidden md:block relative h-[600px] w-full max-w-5xl mx-auto">
                            ...
                            <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-20" style={{ zIndex: 1 }}>
                                ...
                                <circle cx="50%" cy="50%" r="35%" fill="none" stroke="url(#lineGradient)" strokeWidth="1" strokeDasharray="10 5" className="animate-spin" style={{ animationDuration: '30s' }} />
                                <circle cx="50%" cy="50%" r="45%" fill="none" stroke="url(#lineGradient)" strokeWidth="1" strokeDasharray="8 8" className="animate-spin" style={{ animationDuration: '40s', animationDirection: 'reverse' }} />
                            </svg>
                        </div>
                    </div>
                </div>
            ...
            <section className="relative py-24 bg-gradient-to-b from-pink-100 via-white to-pink-100 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold mb-6">
                        ...
                        <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">Digital Journey?</span>
                    </h2>
                    <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                        Let's work together to transform your vision into reality. Our team is ready to help you succeed.
                    </p>
