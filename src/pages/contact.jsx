                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-4">
                            ...
                            <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-orange-400 bg-clip-text text-transparent">Message</span>
                        </h2>
                    ...
                    <div ref={formRef} className="grid grid-cols-1 lg:grid-cols-5 gap-10">
                        ...
                        <div className="lg:col-span-3">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="group">
                                        <label className="block text-sm font-medium text-gray-400 mb-2 group-focus-within:text-blue-400 transition-colors duration-300">
                                            Full Name
                                        </label>
                                        <input
                                            type="text"
                                            ...
                                            className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:border-blue-500/50 focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-300"
                                        />
                                    </div>
                                    <div className="group">
                                        <label className="block text-sm font-medium text-gray-400 mb-2 group-focus-within:text-blue-400 transition-colors duration-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="group">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:border-blue-500/50 focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 appearance-none cursor-pointer"
                                            style={{
                                        ...
                                        >
                                            ...
                                            <option value="digital-strategy" className="bg-gray-900">Digital Strategy</option>
                                ...
                                <div className="group">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:border-blue-500/50 focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 resize-none"
                                    />
                                </div>
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="relative group/btn inline-block">
                                        {/* Glow */}
                                        <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 rounded-2xl opacity-50 group-hover/btn:opacity-100 blur-lg transition-all duration-500" />

                                        <button
                                            type="submit"
                                            disabled={isSubmitting}
                                            className="relative px-10 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 text-white rounded-2xl font-bold text-base shadow-2xl transition-all duration-300 hover:scale-105 inline-flex items-center gap-3 border border-white/10 disabled:opacity-50 disabled:hover:scale-100"
                                        >
                                            {isSubmitting ? (
                                                <>
                                                ...
                                                <>
                                                    Send Message
                                                    <span className="relative flex items-center justify-center w-5 h-5 transition-transform duration-300 group-hover/btn:translate-x-1">
                                                        <span className="absolute w-3.5 h-0.5 bg-white rounded-full" />
                                                        <span className="absolute w-2 h-0.5 bg-white rounded-full rotate-45 translate-x-1 -translate-y-0.5" />
                                                        <span className="absolute w-2 h-0.5 bg-white rounded-full -rotate-45 translate-x-1 translate-y-0.5" />
                                                    </span>
                                                </>
                                            )}
                                            ...
                                            <div className="absolute inset-0 rounded-2xl overflow-hidden">
                                                <div className="absolute top-0 -left-full h-full w-1/2 bg-gradient-to-r from-transparent via-white/15 to-transparent skew-x-12 group-hover/btn:animate-shine" />
                                            </div>
                                        </button>
                                    </div>
                        ...
                        <div ref={mapRef} className="lg:col-span-2">
                            <div className="relative h-full min-h-[400px] lg:min-h-0 rounded-3xl overflow-hidden border border-white/10 group">
                                {/* Map glow border */}
                                <div className="absolute -inset-0.5 bg-gradient-to-br from-blue-500/20 via-transparent to-orange-500/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-700" />

                                <iframe
                                    title="IntelliReach Location"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.123456789!2d77.0857464!3d28.7279396!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDQzJzQwLjciTiA3N8KwMDUnMDguNyJF!5e0!3m2!1sen!2sin!4v1234567890"
                                    className="relative w-full h-full rounded-3xl border-0"
                                ...
                                <div className="absolute bottom-4 left-4 right-4 bg-gray-900/90 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-white font-semibold text-sm">IntelliReach</p>
                                        <p className="text-gray-400 text-xs">Janakpuri, New Delhi - 110058</p>
                                    </div>
                                </div>
                            </div>
                        </div>
