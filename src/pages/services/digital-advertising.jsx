            ...
            <div className="bg-gradient-to-br from-pink-50 via-white to-purple-50 font-manrope overflow-hidden">
                ...
                <section ref={heroRef} className="relative pt-16 pb-20 overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 text-center">
                        ...
                        <h1 className="ad-hero-title text-5xl md:text-6xl lg:text-7xl font-bold mb-2 leading-tight font-playfair">
                            <span className="block text-gray-800">Amplify Your</span>
                            <span className="block bg-gradient-to-r from-orange-600 via-pink-600 to-red-600 bg-clip-text text-transparent pt-2 pb-4">Digital Reach</span>
                        </h1>
                ...
                {/* Projects Section */}
                <section className="pt-20 pb-8 bg-gradient-to-br from-pink-50 via-white to-purple-50 relative overflow-hidden">
                    <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
                        <div className="text-center mb-10">
